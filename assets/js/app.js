...
let addr;
const sttaddr = "0x01f36da395c07698ec32676839c6cd64dd0c938a";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x01f36da395c07698ec32676839c6cd64dd0c938a";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://kastatoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x01f36da395c07698ec32676839c6cd64dd0c938a',
                    'symbol': 'KASTA',
                    'decimals': '9',
                    'image': 'https://kastatoken.net/assets/images/logo.png',
                },
            },
